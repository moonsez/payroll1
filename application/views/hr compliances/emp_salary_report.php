		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">Emp Salary Report</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Emp Salary Report
						</div>
					</div>
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="gen_emp_salary_report" id="gen_emp_salary_report" class="horizontal-form" method="post">
							<div class="form-body">							
								<div class="row">									
									<div class="col-md-6">
