		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">Register of Advances</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Register of Advances
						</div>							
					</div>
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="gen_advance_register" id="gen_advance_register" class="horizontal-form" method="post">
							<div class="form-body">							
								<div class="row">									
									<div class="col-md-6">
