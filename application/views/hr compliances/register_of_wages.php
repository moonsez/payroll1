		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">Register of Wages</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Register of Wages
						</div>							
					</div>
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="gen_register_of_wages_report" id="gen_register_of_wages_report" class="horizontal-form" method="post">
							<div class="form-body">							
								<div class="row">									
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select2me" name="emp_id[]" multiple required>
