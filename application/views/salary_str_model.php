<form action="save_salary_str" id="update" class="horizontal-form">
	<div class="form-body">									
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<label class="control-label" >
						...
						<input type="hidden" name="emp_id" value="<?php echo (isset($singleEmployee->emp_id) && !empty($singleEmployee->emp_id))?$singleEmployee->emp_id:''?>">
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-5">
						<div class="input-group">
							<i class="fa fa-inr"></i>&nbsp;&nbsp;<b><?php echo (($singleEmployee->emp_basic+$gross)-(isset($total_deduct) && !empty($total_deduct)?$total_deduct:'0'))-$minus; ?>.00</b>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<div class="col-md-4">
						<label class="control-label">
							Status<span class="required" aria-required="true">*</span>
						</label>
					</div>
					<div class="col-md-8">
			...
			<div class="col-md-6 hide" id='remark'>
				<div class="form-group">
					<div class="col-md-4">
