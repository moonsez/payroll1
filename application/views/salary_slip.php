...
<div class="page-content-wrapper">
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					...
					<div class="portlet-body form">
						...
						<!-- BEGIN FORM-->
						<form action="pay_slip_data" id="pay_slip_generate_form" class="horizontal-form" method="post">
							<div class="form-body">		
								<div class="row">
									<div class="col-md-6">
							...
							<div class="form-actions">
								<center>
									<button type="submit" class="btn green slipGenerate">Submit</button>
		...
		<div id="salaryGeneratePreview">
			
		</div>	
		<!-- <div id="salaryGeneratepdfPreview">
