				...
				{?>
						...
						<tbody>
							...
							{?>
								<tr class="odd gradeX" style="<?php echo(empty($key->bank_acc_no))?'color:red;':'';?>">
									...
									<td>
										<?php echo (isset($key->pt_amt) && !empty($key->pt_amt))?$key->pt_amt:'';?>
									</td>
									<td style="text-align:center;">
					...
					<div align="right"> 
						...
						<span style="cursor: pointer;" class="tooltips"  data-original-title="Export Excel" data-placement="top">
							...
							<?php if(isset($type) && !empty($type) && ($type=='single_emp'))
							{?>
							<a href="<?php echo base_url();?>generate_excel_report/<?php echo isset($companyId) && !empty($companyId)?$companyId:'';?>/<?php echo (isset($month) && !empty($month))?$month:'';?>/<?php echo (isset($emp_id) && !empty($emp_id))?$emp_id:'';?>">
								 
								Export Excel
							</a>
							<?php }else{ ?>
							<a href="<?php echo base_url();?>basicReportExcel/<?php echo isset($companyId) && !empty($companyId)?$companyId:'';?>/<?php echo (isset($month) && !empty($month))?$month:'';?>">
								Export Excel
							</a>
							<?php } ?>
						...
						<span style="cursor: pointer;" class="tooltips"  data-original-title="Export Excel" data-placement="top">
							...
							<?php }else{ ?>
							<!-- <a href="<?php echo base_url();?>basicReportExcelWithAcc/<?php echo isset($companyId) && !empty($companyId)?$companyId:'';?>/<?php echo (isset($month) && !empty($month))?$month:'';?>/<?php echo (isset($emp_ac_type) && !empty($emp_ac_type))?$emp_ac_type:'';?>">
