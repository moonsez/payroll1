			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					...
					<div class="portlet-body form">
						...
						<!-- BEGIN FORM-->
						<form action="report" id="report_generate_form" class="horizontal-form" method="post">
							<div class="form-body">							
								<div class="row">
									 ...
									 <div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select2me" name="report_type" id="report_type">
												<option value="single_emp">Single Employee</option>
												<option value="All_emp">All Employee</option>
								...
								<div class="row">
									...
									<div class="col-md-6 emp">
										<div class="form-group">
											<label class="control-label">
												Employee Name
												<span class="required" aria-required="true">*</span>
											</label>
											<select class="form-control select2me pre_comp_html" name="slip_emp_name" id="slip_emp_name">
												<option value="">Select</option>
									...
									<div class="col-md-6 emp">
										<div class="form-group">
											...
											<select class="form-control select2me" name="slip_emp_name" id="slip_emp_name">
												<option value="">Select</option>
												<?php if(isset($empDetails) && !empty($empDetails))
												{
													foreach ($empDetails as $key) 
