...
<head>
<meta charset="utf-8"/>
<title>Salary Slip Generate - Login Page</title>
...
<div class="content">
	...
	<form class="login-form" action="<?php echo base_url();?>login" method="post">
		...
		<div class="alert alert-danger alert-wrong-user display-hide">
			<button class="close" data-close="alert"></button>
			<span>Wrong user/password, please try again. </span>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" id="adminname" autocomplete="off" placeholder="Username" name="username"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" id="adminpass" autocomplete="off" placeholder="Password" name="password"/>
			</div>
		</div>
	...
	<form class="register-form" action="index.html" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" id="adminname" type="text" autocomplete="off" placeholder="Username" name="username"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Password</label>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	2014 &copy; Pay slip Generate System.
</div>
<!-- END COPYRIGHT -->
