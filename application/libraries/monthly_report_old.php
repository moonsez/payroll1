...
*/
    function salarySlipReportExcelFormat($emp_basic_data,$company_name,$num_days_of_month,$month,$year)
    {
		...
		/*$CI->excel->getActiveSheet()->setCellValue('A1', 'Statement of Salary expenditure of '.$company_name.' for the Month of '.date("F Y",strtotime($emp_basic_data[0]->salary_month)).''); */
		//$employee_basic_info->emp_comp_name
		$CI->excel->getActiveSheet()->setCellValue('A1', 'Statement of Salary expenditure of '.$company_name.' for the Month of '.$month.' '.$year.''); 
